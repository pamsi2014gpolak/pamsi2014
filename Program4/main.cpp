...
#define ileProb 5   //definiowana jest liczba pomiarów
...
class Eksperyment{
	...
	vector<T> tab;
	vector<T> t;    //wektor pomocniczy, elementy w nim są sortowane, zostaje czyszczony i kopiuje do niego tab
...
void Eksperyment<T>::menu()
{
    int ileElem, rodzajSort, procentSort;
		    ...
		    case 1:
                switch(ileElem)
                {
                    ...
                    case 1000000:
                        ...
                        break;
                    case 10000000:
                        WczytajZPliku("poisson10000000.txt");
                        break;
                    default:
             ...
             case 2:
                    ...
                    case 1000000:
                        ...
                        break;
                    case 10000000:
                        WczytajZPliku("norma10000000.txt");
                        break;
                    default:
                        cout<<"Nie ma takiej opcji"<<endl;
                ...
                case 3:
                    ...
                    case 1000000:
                        ...
                        break;
                    case 10000000:
                        WczytajZPliku("jedno10000000.txt");
                        break;
                    default:
                        cout<<"Nie ma takiej opcji"<<endl;
		...
		for(int licznik=0; licznik<ileProb; licznik++)
		{
			t=tab;
		...
		cout<<"Czas kopcowania: "<<czasSredniKopcowania/ileProb<<endl;
		cout<<"Czas babelkowania: "<<czasSredniBabelkowania/ileProb<<endl;
		cout<<"Czas sortowania introspektywnego: "<<czasSredniIntrospektywnego/ileProb<<endl;
